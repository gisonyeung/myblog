              ...
              <div className="summation">
                {
                  ...
                  <Link to={`/mylife/${this.props.blogId}`} className="icon icon-hot">热度 {hot}</Link>
                  :
                  ''
                }
                {
                  this.props.numbers.comment && this.props.isDetail == 'false' ? 
                  <Link to={`/mylife/${this.props.blogId}`} className="icon icon-comment">评论 {this.props.numbers.comment}</Link>
                  : 
                  ''
                }
                {
